...
<tr><td>Nomor Induk</td><td>: <input type="text" name="nis" size="65" value="<?php  echo $r['nis']; ?>"></td></tr>
...
<table class="art-article" border="0" cellspacing="0" cellpadding="0">
<tr><td>a. Di Kelas</td><td>: <input type="text" name="klsdtrm" size="65" value="<?php  echo $r['klsdtrm']; ?>"></td></tr>
<tr><td>b. Pada Tanggal</td><td>: <input type="text" name="tgldtrm" size="65" value="<?php  echo $r['tgldtrm']; ?>"></td></tr>
<tr><td>c. Semester</td><td>: <input type="text" name="smstdtrm" size="65" value="<?php  echo $r['smstdtrm']; ?>"></td></tr>
</table>
</fieldset>
<fieldset>
<legend> Sekolah Asal</legend>
<table class="art-article" border="0" cellspacing="0" cellpadding="0">
<tr><td>a. Nama Sekolah</td><td>: <input type="text" name="nmaslsklh" size="65" value="<?php  echo $r['nmaslsklh']; ?>"></td></tr>
<tr><td>b. Alamat</td><td>: <input type="text" name="almtaslsklh" size="65" value="<?php  echo $r['almtaslsklh']; ?>"></td></tr>
</table>
</fieldset>
<fieldset>
