...
<tr><td>Program Yang akan diambil</td><td>: <select name="prog">
                                                        
                                                        <option value="ict" >Kelas Unggulan ICT</option>
                                                        <option value="nict" >Kelas Reguler</option>
														<option value="cabut ict" >Cabut ICT</option>
														<option value="cabut reguler" >Cabut Reguler</option>
                                                      </select></td></tr>
...
<table class="art-article" border="0" cellspacing="0" cellpadding="0">
<tr><td width="150">Bahasa Indonesia</td><td>: <input type="text" name="bhs_indo" size="5" maxlength="3" onchange="hitNilai()" value="<?php  echo $r['ind']; ?>"></td></tr>
<tr><td>Bahasa Inggris</td><td>: <input type="text" name="bhs_ing" size="5" maxlength="3" onchange="hitNilai()" value="<?php  echo $r['ing']; ?>"></td></tr>
<tr><td>Matematika</td><td>: <input type="text" name="matematika" size="5" maxlength="3" onchange="hitNilai()" value="<?php  echo $r['mat']; ?>"></td></tr>
<tr><td>IPA</td><td>: <input type="text" name="ipa" size="5" maxlength="3" onchange="hitNilai()" value="<?php  echo $r['ipa']; ?>"></td></tr>
<tr><td>Rata-2 NUN</td><td>: <input type="text" name="nun" size="5" readonly="readonly value="<?php  echo $r['nun']; ?>"></td></tr>
</table>
</fieldset>
</td></tr>
<tr><td colspan="2">
<fieldset>
<legend>Nilai Ujian Sekolah</legend>
<table class="art-article" border="0" cellspacing="0" cellpadding="0">
<tr><td width="150">Pend. Agama</td><td>: <input type="text" name="agama" size="5" maxlength="3" onchange="hitNilais()" value="<?php  echo $r['agam']; ?>"></td></tr>
<tr><td>PPKN</td><td>: <input type="text" name="ppkn" size="5" maxlength="3" onchange="hitNilais()" value="<?php  echo $r['ppkn']; ?>"></td></tr>
<tr><td>IPS</td><td>: <input type="text" name="ips" size="5" maxlength="3" onchange="hitNilais()" value="<?php  echo $r['ips']; ?>"></td></tr>
<tr><td>Pend. Jasmani</td><td>: <input type="text" name="penjas" size="5" maxlength="3" onchange="hitNilais()" value="<?php  echo $r['penjas']; ?>"></td></tr>
<tr><td>Ketrampilan</td><td>: <input type="text" name="ketram" size="5" maxlength="3" onchange="hitNilais()" value="<?php  echo $r['ketram']; ?>"></td></tr>
<tr><td>TIK</td><td>: <input type="text" name="tik" size="5" maxlength="3" onchange="hitNilais()" value="<?php  echo $r['tik']; ?>"></td></tr>

<tr><td>Rata-2 NUS</td><td>: <input type="text" name="nus" size="5" readonly="readonly value="<?php  echo $r['nus']; ?>"></td></tr>
</table>
</fieldset>
</td></tr>
...
<tr><td colspan="2">
<fieldset>
<legend>Piagam / Sertifikat</legend>
<table class="art-article" border="0" cellspacing="0" cellpadding="0">
<tr><td width="150">Jenis</td><td>: <input type="text" name="serjen" size="30"  value="<?php  echo $r['piajen']; ?>"" value=""></td></tr>
<tr><td>Tingkat</td><td>: <input type="text" name="serting" size="30"  value="<?php  echo $r['piating']; ?>"" value=""></td></tr>

</table>
</fieldset>
</td></tr>

<tr><td>Nama Orang Tua / Wali</td><td>: <input type="text" name="nama_orang_tua" size="30" value="<?php  echo $r['ortu']; ?>"></td></tr>
<tr><td>Alamat Orang Tua</td><td>: <input type="text" name="alamat_orang_tua" size="30" value="<?php  echo $r['alamat_ortu']; ?>"></td></tr>
